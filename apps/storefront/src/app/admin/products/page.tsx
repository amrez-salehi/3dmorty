  ...
  const save = async (event: FormEvent) => {
    ...
    try {
      if (editingId) {
        ...
        const sku = form.handle ? `3DM-${form.handle.toUpperCase().replace(/[^A-Z0-9]+/g, "-")}` : `3DM-${Date.now()}`
